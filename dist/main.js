...
/* harmony export */   AreaRenderer: () => (/* binding */ AreaRenderer)
/* harmony export */ });
class AreaRenderer {
    constructor() {
        this.BORDER_SIZE = 2;
    ...
    renderCell(cell, coord) {
        ...
        this.ctx.fillRect(coord.j * this.cellSize + this.BORDER_SIZE, coord.i * this.cellSize + this.BORDER_SIZE, this.cellSize - this.BORDER_SIZE, this.cellSize - this.BORDER_SIZE);
    }
    getCellColor(cell) {
        if (!cell) {
            return "#ffffff";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AreaStateManager: () => (/* binding */ AreaStateManager)
/* harmony export */ });
/* harmony import */ var _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/math-utils */ "./src/utils/math-utils.ts");
...
class AreaStateManager {
    ...
    processInfectedCell(cell, coord) {
        if (cell.stateLifetime > 5) {
            this.area.immunizeCell(coord);
        }
        else {
            const healthyNeighborCoords = this.area.getHealthyNeighborCoords(coord);
            const random = _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__.MathUtils.generateRandomNumber(0, 1);
            if (healthyNeighborCoords.length > 0 && random === 0) {
                const random = _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__.MathUtils.generateRandomNumber(0, healthyNeighborCoords.length - 1);
                this.area.infectCell(healthyNeighborCoords[random]);
            }
        }
    }
    processImmuneCell(cell, coord) {
...
/* harmony export */ });
/* harmony import */ var _area_state_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./area-state-manager */ "./src/area-state-manager.ts");
/* harmony import */ var _models_area__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/area */ "./src/models/area.ts");
const { Chart } = __webpack_require__(/*! chart.js/auto */ "./node_modules/chart.js/auto/auto.cjs");


class Game {
    constructor() {
        this.timeoutInSec = 0.3;
        this.area = new _models_area__WEBPACK_IMPORTED_MODULE_1__.Area(5, 0);
        this.areaStateManager = new _area_state_manager__WEBPACK_IMPORTED_MODULE_0__.AreaStateManager(this.area);
    ...
    showChartHealthy() {
        ...
        const labels = chartData === null || chartData === void 0 ? void 0 : chartData.dataTime;
        const dataHealthy = {
            labels: labels,
            datasets: [{
                    label: 'Здоровые',
...
/* harmony export */ });
/* harmony import */ var _area_renderer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../area-renderer */ "./src/area-renderer.ts");
/* harmony import */ var _utils_math_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/math-utils */ "./src/utils/math-utils.ts");
/* harmony import */ var _cell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cell */ "./src/models/cell.ts");



class Area {
    constructor(size, time, cells) {
        this._size = 3;
        this._cells = new Array();
        this.renderer = new _area_renderer__WEBPACK_IMPORTED_MODULE_0__.AreaRenderer();
        this._time = time;
        this.size = size;
    ...
    initCells(cells) {
        ...
        for (let i = 0; i < this._size; i++) {
            ...
            for (let j = 0; j < this._size; j++) {
                const cell = cells && cells[i][j] ? cells[i][j] : new _cell__WEBPACK_IMPORTED_MODULE_2__.Cell();
    ...
    set size(value) {
        ...
        value = _utils_math_utils__WEBPACK_IMPORTED_MODULE_1__.MathUtils.minMax(value, Area.MIN_SIZE, Area.MAX_SIZE);
    ...
    infectCell(coord) {
        ...
        const succeed = (_a = cell === null || cell === void 0 ? void 0 : cell.infect()) !== null && _a !== void 0 ? _a : false;
    ...
    immunizeCell(coord) {
        var _a;
        const cell = this.getCell(coord);
        const succeed = (_a = cell === null || cell === void 0 ? void 0 : cell.immunize()) !== null && _a !== void 0 ? _a : false;
        this.renderer.renderCell(cell, coord);
        return succeed;
    }
    recoverCell(coord) {
        var _a;
        const cell = this.getCell(coord);
        const succeed = (_a = cell === null || cell === void 0 ? void 0 : cell.recover()) !== null && _a !== void 0 ? _a : false;
        this.renderer.renderCell(cell, coord);
        return succeed;
    }
    render() {
    ...
    getCell(coord) {
        const i = _utils_math_utils__WEBPACK_IMPORTED_MODULE_1__.MathUtils.minMax(coord.i, 0, this._cells.length);
        const j = _utils_math_utils__WEBPACK_IMPORTED_MODULE_1__.MathUtils.minMax(coord.j, 0, this._cells[0].length);
        try {
    ...
    getHealthyNeighborCoords(coord) {
    ...
    copy() {
        return new Area(this._size, this._time, this._cells);
    }
}
Area.MIN_SIZE = 3;
Area.MAX_SIZE = 111;
