...
/* harmony import */ var _area_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./area-renderer */ "./src/area-renderer.ts");
...
class Game {
    constructor() {
        ...
        this.areaRenderer = new _area_renderer__WEBPACK_IMPORTED_MODULE_2__.AreaRenderer();
        this.area = new _models_area__WEBPACK_IMPORTED_MODULE_1__.Area(this.areaRenderer, 5, 0);
...
/* harmony export */ });
/* harmony import */ var _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/math-utils */ "./src/utils/math-utils.ts");
/* harmony import */ var _cell__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cell */ "./src/models/cell.ts");


class Area {
    constructor(renderer, size, time, cells) {
        this._size = 3;
    ...
    initCells(cells) {
        ...
        for (let i = 0; i < this._size; i++) {
            ...
            for (let j = 0; j < this._size; j++) {
                const cell = cells && cells[i][j] ? cells[i][j].copy() : new _cell__WEBPACK_IMPORTED_MODULE_1__.Cell();
    ...
    set size(value) {
        ...
        value = _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__.MathUtils.minMax(value, Area.MIN_SIZE, Area.MAX_SIZE);
    ...
    getCell(coord) {
        const i = _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__.MathUtils.minMax(coord.i, 0, this._cells.length);
        const j = _utils_math_utils__WEBPACK_IMPORTED_MODULE_0__.MathUtils.minMax(coord.j, 0, this._cells[0].length);
        try {
...
/* harmony export */ });
class Cell {
    constructor(state = "healthy", stateLifetime = 0) {
        this._state = "healthy";
